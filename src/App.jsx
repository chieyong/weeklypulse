  ...
  return (<div onClick={()=>{if(colorPick)setColorPick(null);}} style={{background:"#FDF6EE",minHeight:"100vh",width:"100%",boxSizing:"border-box",fontFamily:"Nunito,sans-serif",color:"#3D2E1F"}}>
    ...
    <div className="wk-outer" style={{width:"100%",minHeight:"100vh",display:"flex",flexDirection:"column",padding:"20px 24px 52px",position:"relative"}}>
      <div style={{position:"fixed",top:12,right:12,zIndex:220,display:"flex",alignItems:"center"}} className="wk-edit-btn">
        <button onClick={()=>setTabEdit(!tabEdit)} style={{width:30,height:30,borderRadius:"50%",border:"1px solid rgba(61,46,31,.18)",background:tabEdit?"#C75D3A":"#F7EFE6",color:tabEdit?"white":"#8A7560",cursor:"pointer",display:"flex",alignItems:"center",justifyContent:"center",transition:"all .2s",boxShadow:tabEdit?"0 2px 12px rgba(199,93,58,.25)":"0 2px 8px rgba(61,46,31,.08)",fontSize:"14px",lineHeight:1,fontFamily:"Nunito"}} title="Edit personas & weeks" aria-label="Edit personas & weeks">
